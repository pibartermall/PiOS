...
| pi barter mall for Pi | A large-scale online shopping mall, pioneers use PI coins to purchase goods or services, with more than 1 million registered users, and won the PI NETWORK Hackathon Honor Award | Consumer Utility | Node.js,Vue3, Html,Javascript, Mysql | [pi barter mall for Pi](https://github.com/pi-apps/Pibartermall) | pi://brainstorm.pi/project/60de794d35accf62f3ce4b7e | [demo](https://www.lgkm.net/) | (https://www.lgkm.net/) | (https://www.lgkm.net/) |
